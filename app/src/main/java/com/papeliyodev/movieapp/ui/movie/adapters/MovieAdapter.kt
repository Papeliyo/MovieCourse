package com.papeliyodev.movieapp.ui.movie.adapters
...
import com.papeliyodev.movieapp.core.BaseViewHolder
import com.papeliyodev.movieapp.data.model.Movie
import com.papeliyodev.movieapp.databinding.MovieItemBinding
...
class MovieAdapter(private val movieList: List<Movie>, private val itemClickListener: OnMovieClickListener): RecyclerView.Adapter<BaseViewHolder<*>>() {
    ...
    //Dibujar en patalla cada uno de los elementos
    ...
    private inner class MovieViewHolder(val binding: MovieItemBinding, val context: Context): BaseViewHolder<Movie>(binding.root){
